    ...
    <header className="bg-black dark:bg-[#d5420b] flex justify-between items-center py-6 px-10 shadow-sm">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold text-[#d5420b]">
          {organization.name} Resu<span className="text-white">master</span>
        </h1>
      </div>
      ...
      <nav className={`md:flex justify-center flex-grow ${isOpen ? "block" : "hidden"}`}>
        ...
        <li>
            <Link to="/login" className="hover:shadow-md hover:animate-pulse hover:text-[#d5420b] flex items-center transition duration-300 ease-in-out">
              Login
            </Link>
          </li>
          <li>
            <Link to="/signup" className="hover:shadow-md hover:animate-pulse hover:text-[#d5420b] flex items-center transition duration-300 ease-in-out">
              Signup
            </Link>
          </li>
        </ul>
