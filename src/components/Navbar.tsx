...
import { faBars, faEnvelope, faUser, faToolbox, faDollar, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900" data-aos="fade-down">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:px-6 lg:px-8">
        <div className="flex  space-x-3 md:space-x-0 rtl:space-x-reverse">
          <Link to="/" className="flex items-center md:order-2 ">
        ...
        <div className={`${isOpen ? 'flex' : 'hidden'} items-center justify-center w-full mt-2 md:flex md:w-auto md:order-1`} id="navbar-cta">
          <ul className="flex flex-col font-medium  border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700" data-aos={isOpen ? 'fade-right' : ''}>
            <li>
              <Link to="/" className={`block py-2 px-3 md:p-0 ${isOpen ? 'text-blue-700' : 'text-gray-900'} rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>
                <FontAwesomeIcon icon={faToolbox} className="w-5 h-5 mr-2" />
                Tools
              </Link>
            </li>
            <li>
              <Link to="/pricing" className={`block py-2 px-3 md:p-0 ${isOpen ? 'text-blue-700' : 'text-gray-900'} rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>
                <FontAwesomeIcon icon={faDollar} className="w-5 h-5 mr-2" />
                Pricing
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to ="/login" className='flex flex-wrap items-center justify-center px-4 py-2 text-sm font-medium text-center text-black '>
