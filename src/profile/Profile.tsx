...
const Profile = () => {
  ...
  return (
    <div className="bg-noise bg-cover bg-center bg-initial container mx-auto p-6" data-aos="fade-in">
      <div className="grid gap-6 mb-6 md:grid-cols-2" data-aos="fade-up">
        <div className="rounded-lg shadow-lg p-6 border border-gray-700 animate-fade-in relative" data-aos="zoom-in">
          ...
          <img
            ...
            data-aos="zoom-in"
          />
          <h2 className="text-2xl font-bold text-black" data-aos="fade-up">{user.name}</h2>
          <p className="text-sm text-blue-800 font-medium" data-aos="fade-up">Software Engineer</p>
          <p className="text-sm text-blue-800" data-aos="fade-up">{user.bio}</p>
        ...
        <div className="rounded-lg shadow-lg p-4 bg-initial border border-gray-700 animate-fade-in" data-aos="fade-up">
          <h3 className="text-xl font-semibold text-black mb-4 flex items-center" data-aos="fade-up">
            <FontAwesomeIcon icon={faUser} className="mr-2 text-2xl text-blue-800" />
            Profile Details
          </h3>
          <ul className="space-y-4 text-sm divide-y divide-gray-700" data-aos="fade-up">
            <li className="flex justify-between items-center py-2" data-aos="fade-up">
              <span className="flex items-center">
                <FontAwesomeIcon icon={faCode} className="mr-2 text-lg text-blue-800" />
            ...
            <li className="flex justify-between items-center py-2" data-aos="fade-up">
              <span className="flex items-center">
                <FontAwesomeIcon icon={faReadme} className="mr-2 text-lg text-blue-800" />
            ...
            <li className="flex flex-col py-2" data-aos="fade-up">
              <span className="flex items-center">
                <FontAwesomeIcon icon={faList} className="mr-2 text-lg text-blue-800" />
              ...
              <ul className="ml-6 space-y-1 text-sm mt-2" data-aos="fade-up">
                {user.details.skills?.length ? (
                  user.details.skills.map((skill, index) => (
                    <li key={index} className="border-l-2 border-blue-800 pl-2">
                      {skill}
                    </li>
                  ))
                ) : (
      ...
      <div className=" rounded-lg  shadow-lg p-6 md:p-8 bg-initial border border-gray-700 animate-fade-in" data-aos="fade-up">
        <h3 className="text-xl font-semibold text-black mb-4 md:mb-6 flex items-center" data-aos="fade-up">
          <FontAwesomeIcon icon={faFile} className="mr-2 text-lg text-blue-800" />
          Subscription Details
        </h3>
        <ul className="space-y-4 text-black divide-y divide-gray-700" data-aos="fade-up">
          <li className="flex justify-between items-center py-2" data-aos="fade-up">
            <span className="flex items-center">
              <FontAwesomeIcon icon={faLightbulb} className="mr-2 text-lg text-blue-800" />
          ...
          <li className="flex justify-between items-center py-2" data-aos="fade-up">
            <span className="flex items-center">
              <FontAwesomeIcon icon={faCalendar} className="mr-2 text-lg text-blue-800" />
          ...
          <li className="flex justify-between items-center py-2" data-aos="fade-up">
            <span className="flex items-center">
              <FontAwesomeIcon icon={faClock} className="mr-2 text-lg text-blue-800" />
      ...
      <div className="rounded-lg mt-6 shadow-lg p-4 md:p-6 bg-initial border border-gray-700" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
        <h3 className="text-xl font-semibold text-black mb-4 md:mb-6 flex items-center" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
          <FontAwesomeIcon icon={faChartPie} className="mr-4 text-2xl text-blue-800" />
        ...
        <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
          <div className="flex items-center justify-between bg-initial rounded-lg shadow-lg p-4 md:p-6 border border-gray-700" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
            <div className="flex items-center">
              <FontAwesomeIcon icon={faFile} className="mr-4 text-2xl text-blue-800" />
              <span className="font-medium text-black">Total Resumes Generated:</span>
            </div>
            <span className="font-semibold text-3xl text-black">{user.resumes.length}</span>
          ...
          <div className="flex items-center justify-between bg-initial rounded-lg shadow-lg p-4 md:p-6 border border-gray-700" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
            <div className="flex items-center">
              <FontAwesomeIcon icon={faFile} className="mr-4 text-2xl text-blue-800" />
              <span className="font-medium text-black">Total Templates Selected:</span>
            </div>
            <span className="font-semibold text-3xl text-black">{user.templates.length}</span>
            <span className="hidden group-hover:block absolute top-0 right-0 px-2 py-1 text-sm font-semibold text-white bg-initial rounded-b">{user.templates.length} Templates Selected</span>
          </div>
        </div>
      </div>
      <div className="rounded-lg mt-6  shadow-lg p-6 md:p-8 bg-initial border border-gray-700 animate-fade-in" data-aos="fade-up">
        <h3 className="text-xl font-semibold text-black mb-4 md:mb-6 flex items-center" data-aos="fade-up">
          <FontAwesomeIcon icon={faFile} className="mr-2 text-lg text-blue-800" />
          Templates Used
        </h3>
      ...
      <div className="mt-6 rounded-lg shadow-lg p-4 bg-gray-800 border border-gray-700 animate-fade-in" data-aos="fade-up">
        <h3 className="text-xl font-semibold text-white mb-4 flex items-center" data-aos="fade-up">
          <FontAwesomeIcon icon={faBookOpen} className="mr-2 text-lg text-blue-800" />
          Generated Resumes
        </h3>
