...
const Template = () => {
    ...
    return (
        <>
        <div className=' min-h-screen flex flex-col justify-center items-center p-4' data-aos="fade-down" data-aos-duration="1500" data-aos-once="false">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-4" data-aos="zoom-in">
          <div className="mx-auto max-w-2xl lg:text-center" data-aos="fade-up">
            <p className="mt-2 text-4xl font-medium tracking-tight text-blue-500 sm:text-5xl">
              <span className="text-blue-500">Choose your </span>template
            </p>
          </div>
          ...
          <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-black shadow-lg transition duration-150 ease-in-out hover:shadow-2xl">
            <img
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 transition duration-150 ease-in-out group-hover:opacity-100">
              <p className="bg-black rounded-lg border-black border-white border-solid p-4 text-3xl font-bold text-white">{resumeTemplate.name}</p>
            </div>
          </div>
              
              <Link to={`/resume/editor/${resumeTemplate.id}`}>

          <button className="mt-4 block w-full text-white bg-blue-500 font-bold py-2 rounded-lg hover:bg-blue-600 transition duration-150 ease-in-out" data-aos="zoom-in">
             Use Template
          </button>
              </Link>
              </div>
