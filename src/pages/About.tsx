...
const About = () => {
  ...
  return (
    ...
    <section className="text-gray-600 body-font bg-no-repeat bg-right-top bg-contain" style={{ backgroundImage: 'url(kumar1.jpg)' }} data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="1500">
      {about.map((about) => (
