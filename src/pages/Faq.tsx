...
const Faq = () => {
    ...
    return (
        <div className="bg-blue-50 py-16 px-5 sm:px-10 relative">
            ...
            <h1 className="text-4xl text-blue-600 font-bold text-center mb-10">Frequently Asked Questions</h1>
            <div className="max-w-4xl mx-auto">
            <div className="space-y-4">
                {faqs.map((faq, index) => (
                <div key={faq.question} className="bg-white rounded-md shadow-md p-4">
