        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <form onSubmit={handleFormSubmit} className="grid grid-cols-1 gap-4 p-8 bg-white rounded-lg shadow-md md:grid-cols-2" data-aos="zoom-in">
                ...
                <div className="flex items-center space-x-2 md:col-span-2">
                    ...
                    <textarea name="message" id="message" placeholder="Message" defaultValue={appointment.message} onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) => handleInputChange(event)} className="flex-1 border border-gray-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required cols={30} rows={10}></textarea>
                </div>
