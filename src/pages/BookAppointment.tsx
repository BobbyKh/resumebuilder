...
import { faUser, faEnvelope, faPhone, faCalendarAlt, faClock, faCommentDots } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        ...
        <form onSubmit={handleFormSubmit} className="grid grid-cols-1 gap-4 p-8 bg-white rounded-lg shadow-md md:grid-cols-2" data-aos="zoom-in">
            ...
            <div className="flex items-center space-x-2 md:col-span-2">
                ...
                <input type="text" name="message" id="message" placeholder="Message" defaultValue={appointment.message} onChange={handleInputChange} className="flex-1 border border-gray-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"required/>
            </div>
            ...
            {appointment.id && <p className="col-span-full text-center text-green-500">Appointment Booked Successfully! We will contact you soon.</p>}
        </form>
        </div>
    )
}
