...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen pb-28 sm:pb-0" style={{ backgroundImage: "url('https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260')" }}>
